...
const createConnectionSchema = z.object({
  ...
  authType: z.enum(['SERVICE_ACCOUNT', 'API_KEY', 'APPLICATION_DEFAULT']),
  ...
  try {
    const connections = await prisma.gcpConnection.findMany({
      ...
      select: {
        ...
        billingJobProjectId: true,
        billingDatasetId: true,
        billingTableName: true,
  ...
  try {
    ...
    const connection = await prisma.gcpConnection.create({
      data: {
        ...
        billingProjectId: data.billingProjectId ?? null,
        billingJobProjectId: data.billingJobProjectId ?? null,
        billingDatasetId: data.billingDatasetId ?? null,
        billingTableName: data.billingTableName ?? null,
        billingAccountIds: data.billingAccountIds ?? [],
